...
export function Notification({content}: NotificationProps) {
  PushNotification.localNotificationSchedule({
    /* Android Only Properties */
    channelId: 'plant-reminder-channel', // (required) channelId, if the channel doesn't exist, notification will not trigger.
    ...
    id: content.id, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
